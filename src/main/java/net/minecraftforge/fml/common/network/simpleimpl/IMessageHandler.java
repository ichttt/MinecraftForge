 ...
 * You can use {@link MessageContext#reply(IMessage)} to reply to this message
 *
 * @author cpw
 *
 * @param <REQ> This is the request type - it is the message you expect to <em>receive</em> from remote.
 */
public interface IMessageHandler<REQ extends IMessage> {
    /**
     ...
     */
    void onMessage(REQ message, MessageContext ctx);
}
